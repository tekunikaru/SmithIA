from gerador_dados_ficticios import caf114, cafft030, router, romoes40
import csv
import datetime
...
rng_p_4, rng_spindle_entrada_4, velocidade_simulado = romoes40()
...
for (vp4, v_SE, Fv) in zip(rng_p_4, rng_spindle_entrada_4, velocidade_simulado):
    registros.append([4, 'potencia', vp4, hora_atual])
    registros.append([4, 'spindle_entrada', v_SE, hora_atual])
    registros.append([4, 'faixa_velocidade', Fv, hora_atual])
